...
async def insert_base_data(session = Depends(get_session)):
    ...
    tags = [
        ...
        Tags(description="Promoção", color="#0ea5e9"),

        Tags(description="Tarifa Light", color="#64748b"),
        Tags(description="Tarifa Flex", color="#06b6d4"),
        Tags(description="Tarifa Plus", color="#14b8a6"),

        Tags(description="Voo direto", color="#10b981"),
        Tags(description="Conexão", color="#f59e0b"),
    ]
